...
const bumbVersionAndSave = () => {
    ...
    execSync(`cd packages/nocodb && npm install --save --save-exact sgeist-${ncLibPackage.name}@${ncLibPackage.version}`, {});
    // execSync(`cd packages/nocodb && npm install --save --save-exact sgeist-${ncLibPackage.name}@${nocodbSdkPackageVersion}`, {});
